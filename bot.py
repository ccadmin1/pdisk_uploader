...
THUMB_URL = environ.get('THUMB_URL','https://telegra.ph/file/12f994253932c4638942e.jpg')
...
async def pdisk_up(link):
    if ('pdisk' in link or 'kuklink' in link or 'kofilink' in link or 'cofilink' in link or 'bit' in link or link in 'vdshort' or link in 'vidrivers' or link in 'linkpdisk' or link in 'pdislin'):
...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i or 't.me' in i or 'https://bit.ly/3DD8N2j' in i or 'https://bit.ly/2Yyp8Gc' in i or 'telegra.ph' in i):
            new_List.remove(i)
    return new_List
